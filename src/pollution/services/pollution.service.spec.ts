...
describe('PollutionService', () => {
  ...
  let airQualityApiService: AirQualityApiService;
  ...
  beforeEach(async () => {
    ...
    airQualityApiService = module.get<AirQualityApiService>(AirQualityApiService);
  });
  ...
  it('should be defined', async () => {
    expect(await pollutionService.getPollutionInNearestCityToCoordinates(36.475792, 2.829758))
    .toEqual({
      Pollution: {
        ts: "2023-02-01T12:00:00.000Z",
        aqius: 29,
